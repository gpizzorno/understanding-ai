...
- Browser-based: Teachable Machine; Gandalf; an LLM interface such as NotebookLM (or an equivalent provided by the instructors)
- Python-based (Day 2): Jupyter (local or hosted), and libraries/tools for working with pre-trained models (e.g., Hugging Face)

## Prework

Participants should plan on modest prework in advance of Day 1, and optional preparation between days.

- Bring a laptop with a modern web browser
- Optional but recommended: a GitHub account (useful for accessing shared materials)
- For Day 2: access to a Python/Jupyter environment (local install or a hosted option such as Google Colab)
- If you want to brush up on Python between sessions, a short self-paced Python introduction will be provided

## Plan

### Day 1: Concepts, evaluation, and off-the-shelf tools
